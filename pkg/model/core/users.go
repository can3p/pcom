...
var UserRels = struct {
	...
	PostPostPrompts:      "PostPostPrompts",
...
type userR struct {
	...
	PostPostPrompts                           PostPromptSlice                     `boil:"PostPostPrompts" json:"PostPostPrompts" toml:"PostPostPrompts" yaml:"PostPostPrompts"`
...
func (r *userR) GetUserAPIKey() *UserAPIKey {
	if r == nil {
		return nil
	}
	return r.UserAPIKey
...
func (r *userR) GetPostComments() PostCommentSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetAskerPostPrompts() PostPromptSlice {
	if r == nil {
		return nil
	}
	return r.AskerPostPrompts
}

func (r *userR) GetPostPostPrompts() PostPromptSlice {
	if r == nil {
		return nil
	}
	return r.PostPostPrompts
}

func (r *userR) GetRecipientPostPrompts() PostPromptSlice {
	if r == nil {
		return nil
	}
	return r.RecipientPostPrompts
}
...
func (r *userR) GetTargetUserUserConnectionMediationRequests() UserConnectionMediationRequestSlice {
	...
	return r.TargetUserUserConnectionMediationRequests
}

func (r *userR) GetWhoUserUserConnectionMediationRequests() UserConnectionMediationRequestSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetUser1UserConnections() UserConnectionSlice {
	...
	return r.User1UserConnections
}

func (r *userR) GetUser2UserConnections() UserConnectionSlice {
	if r == nil {
		return nil
	}
...
func (o *User) MediaUploads(mods ...qm.QueryMod) mediaUploadQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"media_uploads\".\"user_id\"=?", o.ID),
	)
...
func (o *User) AskerPostPrompts(mods ...qm.QueryMod) postPromptQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"post_prompts\".\"asker_id\"=?", o.ID),
	)

	return PostPrompts(queryMods...)
}

// PostPostPrompts retrieves all the post_prompt's PostPrompts with an executor via post_id column.
func (o *User) PostPostPrompts(mods ...qm.QueryMod) postPromptQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (o *User) RecipientPostPrompts(mods ...qm.QueryMod) postPromptQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"post_prompts\".\"recipient_id\"=?", o.ID),
	)
...
func (o *User) TargetUserUserConnectionMediationRequests(mods ...qm.QueryMod) userConnectionMediationRequestQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_connection_mediation_requests\".\"target_user_id\"=?", o.ID),
	)
...
func (o *User) WhoUserUserConnectionMediationRequests(mods ...qm.QueryMod) userConnectionMediationRequestQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_connection_mediation_requests\".\"who_user_id\"=?", o.ID),
	)
...
func (o *User) User1UserConnections(mods ...qm.QueryMod) userConnectionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_connections\".\"user1_id\"=?", o.ID),
	)
...
func (o *User) User2UserConnections(mods ...qm.QueryMod) userConnectionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_connections\".\"user2_id\"=?", o.ID),
	)
...
// LoadUserAPIKey allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (userL) LoadUserAPIKey(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_api_keys`),
		qm.WhereIn(`user_api_keys.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load UserAPIKey")
	}

	var resultSlice []*UserAPIKey
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice UserAPIKey")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for user_api_keys")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for user_api_keys")
	}
...
func (userL) LoadMediaUploads(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`media_uploads.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadPostComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`post_comments.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadAskerPostPrompts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadAskerPostPrompts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`post_prompts.asker_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.AskerPostPrompts = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &postPromptR{}
			}
			foreign.R.Asker = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.AskerID {
				local.R.AskerPostPrompts = append(local.R.AskerPostPrompts, foreign)
				if foreign.R == nil {
					foreign.R = &postPromptR{}
				}
				foreign.R.Asker = local
				break
			}
		}
	}
...
// LoadPostPostPrompts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPostPostPrompts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		object.R.PostPostPrompts = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &postPromptR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.PostID) {
				local.R.PostPostPrompts = append(local.R.PostPostPrompts, foreign)
				if foreign.R == nil {
					foreign.R = &postPromptR{}
				}
...
// LoadRecipientPostPrompts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadRecipientPostPrompts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`post_prompts`),
		qm.WhereIn(`post_prompts.recipient_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.RecipientPostPrompts = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &postPromptR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.RecipientID {
				local.R.RecipientPostPrompts = append(local.R.RecipientPostPrompts, foreign)
				if foreign.R == nil {
					foreign.R = &postPromptR{}
				}
...
func (userL) LoadTargetUserUserConnectionMediationRequests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_connection_mediation_requests.target_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TargetUserUserConnectionMediationRequests = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.TargetUserID {
				local.R.TargetUserUserConnectionMediationRequests = append(local.R.TargetUserUserConnectionMediationRequests, foreign)
				if foreign.R == nil {
					foreign.R = &userConnectionMediationRequestR{}
				}
...
// LoadWhoUserUserConnectionMediationRequests allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadWhoUserUserConnectionMediationRequests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_connection_mediation_requests`),
		qm.WhereIn(`user_connection_mediation_requests.who_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.WhoUserUserConnectionMediationRequests = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userConnectionMediationRequestR{}
			}
			foreign.R.WhoUser = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.WhoUserID {
				local.R.WhoUserUserConnectionMediationRequests = append(local.R.WhoUserUserConnectionMediationRequests, foreign)
				if foreign.R == nil {
					foreign.R = &userConnectionMediationRequestR{}
				}
...
// LoadUser1UserConnections allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUser1UserConnections(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_connections.user1_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load user_connections")
	}

	var resultSlice []*UserConnection
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice user_connections")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on user_connections")
	}
	if err = results.Err(); err != nil {
	...
	if singular {
		object.R.User1UserConnections = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.User1ID {
				local.R.User1UserConnections = append(local.R.User1UserConnections, foreign)
				if foreign.R == nil {
					foreign.R = &userConnectionR{}
				}
...
// LoadUser2UserConnections allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUser2UserConnections(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_connections`),
		qm.WhereIn(`user_connections.user2_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.User2UserConnections = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userConnectionR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.User2ID {
				local.R.User2UserConnections = append(local.R.User2UserConnections, foreign)
				if foreign.R == nil {
					foreign.R = &userConnectionR{}
				}
...
// SetUserAPIKeyP of the user to the related item.
// Sets o.R.UserAPIKey to related.
...
func (o *User) SetUserAPIKeyP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserAPIKey) {
	if err := o.SetUserAPIKey(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserAPIKey of the user to the related item.
// Sets o.R.UserAPIKey to related.
// Adds o to related.R.User.
...
// AddAskerPostPromptsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.AskerPostPrompts.
// Sets related.R.Asker appropriately.
// Panics on error.
func (o *User) AddAskerPostPromptsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) {
	if err := o.AddAskerPostPrompts(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddAskerPostPrompts adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.AskerPostPrompts.
// Sets related.R.Asker appropriately.
func (o *User) AddAskerPostPrompts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) error {
	...
	if o.R == nil {
		o.R = &userR{
			AskerPostPrompts: related,
		}
	} else {
		o.R.AskerPostPrompts = append(o.R.AskerPostPrompts, related...)
	}
...
// AddPostPostPromptsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.PostPostPrompts.
// Sets related.R.Post appropriately.
// Panics on error.
func (o *User) AddPostPostPromptsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) {
	if err := o.AddPostPostPrompts(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddPostPostPrompts adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.PostPostPrompts.
// Sets related.R.Post appropriately.
func (o *User) AddPostPostPrompts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) error {
	var err error
	for _, rel := range related {
		if insert {
	...
	if o.R == nil {
		o.R = &userR{
			PostPostPrompts: related,
		}
	} else {
		o.R.PostPostPrompts = append(o.R.PostPostPrompts, related...)
	}
...
// SetPostPostPromptsP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Post's PostPostPrompts accordingly.
// Replaces o.R.PostPostPrompts with related.
// Sets related.R.Post's PostPostPrompts accordingly.
// Panics on error.
func (o *User) SetPostPostPromptsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) {
	if err := o.SetPostPostPrompts(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetPostPostPrompts removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Post's PostPostPrompts accordingly.
// Replaces o.R.PostPostPrompts with related.
// Sets related.R.Post's PostPostPrompts accordingly.
func (o *User) SetPostPostPrompts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) error {
	...
	if o.R != nil {
		for _, rel := range o.R.PostPostPrompts {
		...
		o.R.PostPostPrompts = nil
	}

	return o.AddPostPostPrompts(ctx, exec, insert, related...)
}

// RemovePostPostPromptsP relationships from objects passed in.
// Removes related items from R.PostPostPrompts (uses pointer comparison, removal does not keep order)
// Sets related.R.Post.
// Panics on error.
func (o *User) RemovePostPostPromptsP(ctx context.Context, exec boil.ContextExecutor, related ...*PostPrompt) {
	if err := o.RemovePostPostPrompts(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemovePostPostPrompts relationships from objects passed in.
// Removes related items from R.PostPostPrompts (uses pointer comparison, removal does not keep order)
// Sets related.R.Post.
func (o *User) RemovePostPostPrompts(ctx context.Context, exec boil.ContextExecutor, related ...*PostPrompt) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.PostPostPrompts {
			if rel != ri {
				continue
			}

			ln := len(o.R.PostPostPrompts)
			if ln > 1 && i < ln-1 {
				o.R.PostPostPrompts[i] = o.R.PostPostPrompts[ln-1]
			}
			o.R.PostPostPrompts = o.R.PostPostPrompts[:ln-1]
			break
		}
	}
...
// AddRecipientPostPromptsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.RecipientPostPrompts.
...
func (o *User) AddRecipientPostPromptsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) {
	if err := o.AddRecipientPostPrompts(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddRecipientPostPrompts adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.RecipientPostPrompts.
// Sets related.R.Recipient appropriately.
func (o *User) AddRecipientPostPrompts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPrompt) error {
	...
	if o.R == nil {
		o.R = &userR{
			RecipientPostPrompts: related,
		}
	} else {
		o.R.RecipientPostPrompts = append(o.R.RecipientPostPrompts, related...)
	}
...
func (o *User) AddTargetUserUserConnectionMediationRequestsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnectionMediationRequest) {
	if err := o.AddTargetUserUserConnectionMediationRequests(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddTargetUserUserConnectionMediationRequests adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.TargetUserUserConnectionMediationRequests.
// Sets related.R.TargetUser appropriately.
func (o *User) AddTargetUserUserConnectionMediationRequests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnectionMediationRequest) error {
	...
	if o.R == nil {
		o.R = &userR{
			TargetUserUserConnectionMediationRequests: related,
		}
	} else {
		o.R.TargetUserUserConnectionMediationRequests = append(o.R.TargetUserUserConnectionMediationRequests, related...)
	}
...
// AddWhoUserUserConnectionMediationRequestsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WhoUserUserConnectionMediationRequests.
// Sets related.R.WhoUser appropriately.
// Panics on error.
func (o *User) AddWhoUserUserConnectionMediationRequestsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnectionMediationRequest) {
	if err := o.AddWhoUserUserConnectionMediationRequests(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddWhoUserUserConnectionMediationRequests adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.WhoUserUserConnectionMediationRequests.
// Sets related.R.WhoUser appropriately.
func (o *User) AddWhoUserUserConnectionMediationRequests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnectionMediationRequest) error {
	...
	if o.R == nil {
		o.R = &userR{
			WhoUserUserConnectionMediationRequests: related,
		}
	} else {
		o.R.WhoUserUserConnectionMediationRequests = append(o.R.WhoUserUserConnectionMediationRequests, related...)
	}
...
// AddUser1UserConnectionsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1UserConnections.
...
func (o *User) AddUser1UserConnectionsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnection) {
	if err := o.AddUser1UserConnections(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddUser1UserConnections adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User1UserConnections.
// Sets related.R.User1 appropriately.
func (o *User) AddUser1UserConnections(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnection) error {
	...
	if o.R == nil {
		o.R = &userR{
			User1UserConnections: related,
		}
	} else {
		o.R.User1UserConnections = append(o.R.User1UserConnections, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &userConnectionR{
				User1: o,
			}
		} else {
			rel.R.User1 = o
...
// AddUser2UserConnectionsP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User2UserConnections.
...
func (o *User) AddUser2UserConnectionsP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnection) {
	if err := o.AddUser2UserConnections(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddUser2UserConnections adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.User2UserConnections.
// Sets related.R.User2 appropriately.
func (o *User) AddUser2UserConnections(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserConnection) error {
	...
	if o.R == nil {
		o.R = &userR{
			User2UserConnections: related,
		}
	} else {
		o.R.User2UserConnections = append(o.R.User2UserConnections, related...)
	}
