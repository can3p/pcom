...
|---|---|---|
| strong | `opus` | W0; wave coordination; visibility/permission tests (W2.D2a, W3.E1); R1 skeleton; R5 planning |
| mid | `sonnet` | business-logic tests (connections, forms, feed composition), E2E scenarios, WB fixes |
